...
<b>AI 1 - "AI Was Consulted in the Making..."</b> A rating of 1 means AI was actively consulted in the creation of your project. This includes brainstorming or learning from an AI chatbot. This rating also applies to the use of AI tools in specific areas on a project, such as for visual cleanup, for increased pixel resolution (ie upscaling), for making an arduous task easier (for example, UV unwrapping a 3D model), for spellchecking, for project organization, etc. Essentially, if AI tools were used in a project, but all the work seen or heard is handmade, a rating of 1 is appropriate.

<b>AI 2 - "...Includes Some AI Generation."</b> A rating of 2 means that some machine-made art, sound, words, or concepts are present in the work. This can include AI generated artwork, music, code, or dialogue which is subsidizing primarily handmade work. This rating is appropriate if you have, for example, localized your project into various langauges using AI; if you have some AI-voiced characters; if you have an AI generated filter over your video to give it a different look; if you've used AI to create remixes of your songs; or you have some visuals, sounds, music, or dialogue which have been AI generated. A rating of 2 is appropriate for most projects that say they have some AI present in the work or that the work was achieved with the help of AI.
